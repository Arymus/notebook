        ...
        case "update":
            ...
            if (upd.toLowerCase() === "y") {
                ...
                try {
                    ...
                    exec(`pwsh -Command "git pull ${prompt("Repository name: ")} ${prompt("Branch to commit to: ")}"`, (error, stderr, stdout) => {
                    ...
                    exec(`pwsh -Command "git push -u ${prompt("Confirm name: ")} ${prompt("Confirm branch: ")}"`, (error, stderr, stdout) => {
