        ...
        case "update":
            ...
            if (upd.toLowerCase() === "y") {
                ...
                try {
                    ...
                    exec(`su root --command git pull ${prompt("Repository name: ")} ${prompt("Branch to commit to: ")}`, (error, stdout, stderr) => {
                    ...
                    exec(`su root --command git push -u ${prompt("Confirm name: ")} ${prompt("Confirm branch: ")}`, (error, stdout, stderr) => {
