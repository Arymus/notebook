...
module.exports = function run(cmd) {
    ...
    switch (cmd) {
        ...
        case "update":
            ...
            // Prompt the user
            const upd = prompt("Please make sure you are on the branch you wish to commit to using `notebook open` before you proceed. Continue? (Y/N) ");
            ...
            if (upd.toLowerCase() === "y") {
                ...
                try {
                    ...
                    try {
                        ...
                        exec(`git push -u ${prompt("Repository name: ")} ${prompt("Branch name: ")}`, (error, stdout, stderr) => {
        ...
        case "branch":
            ...
            console.log("Note that you cannot create a new branch without making 1 commit to your starting branch. \n\n");
        ...
        // Log a warning message
        console.log("Note that you cannot view your starting branch without making at least 1 commit to it. \n\n");
            ...
            exec(`git remote -v`, (error, stdout, stderr) => {
                ...
                // If else (successful)
                    ...
                    stdout !== "" ?
                    console.log("Remote repositories: \n" + stdout) : // Log the remote repositories
        ...
        case "merge":
            ...
            // Prompt the user
            const merge = prompt("Please make sure you're in the target branch before merging. Continue? (Y/N) ");

            // If merge as lowercase is "y"
            if (merge.toLowerCase() === "y") {

                // Merge two branches
                exec(`git merge ${prompt("Branch you want to merge: ")}`, (error, stdout, stderr) => {
            ...
            // If merge as lowercase is "n"
            } else if (merge.toLowerCase() === "n") {
                console.log("Process terminated. Run `notebook view` to see all branches."); // Log termination message
            } else {
                console.log("Invalid input. Process terminated"); // Log error message
            };
            break; // End case checking
