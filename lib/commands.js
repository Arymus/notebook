        ...
        case "update":
            ...
            if (upd.toLowerCase() === "y") {
                ...
                try {
                    ...
                    exec(`su git pull ${prompt("Repository name: ")} ${prompt("Branch to commit to: ")}`, (error, stdout, stderr) => {
                    ...
                    exec(`su git push -u ${prompt("Confirm name: ")} ${prompt("Confirm branch: ")}`, (error, stdout, stderr) => {
