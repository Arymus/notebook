        ...
        case "update":
            ...
            if (upd.toLowerCase() === "y") {
                ...
                try {
                    ...
                    exec(`su $USER -c git pull ${prompt("Repository name: ")} ${prompt("Branch to commit to: ")}`, (error, stdout, stderr) => {
                    ...
                    exec(`su $USER -c git push -u ${prompt("Confirm name: ")} ${prompt("Confirm branch: ")}`, (error, stdout, stderr) => {
