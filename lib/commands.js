        ...
        case "update":
            ...
            if (upd.toLowerCase() === "y") {
                ...
                try {
                    ...
                    exec(sudo(`git pull ${prompt("Repository name: ")} ${prompt("Branch to commit to: ")}`, (error, stderr, stdout) => {
                    ...
                    exec(sudo(`git push -u ${prompt("Confirm name: ")} ${prompt("Confirm branch: ")}`, (error, stderr, stdout) => {
